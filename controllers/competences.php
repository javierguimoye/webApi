...
class competences extends _controller
{
    ...
    public function index(Req $req)
    {
        ...
        $qb = Competence::where('state', '!=', Competence::_STATE_DELETED);
    ...
    {
        $item = Competence::find($req->num('id'));
    ...
    {
        return rsp(true)
            ->set('item', Competence::find($req->num('id')));
    }

    public function remove(Req $req)
    {
        return Competence::deleteRSP($req->num('id'));
    }
