...
class compekits extends _controller
{
    ...
    public function index(Req $req)
    {
        ...
        $qb = Compekit::where('state', '!=', Compekit::_STATE_DELETED);
    ...
    {
        return rsp(true)
            ->set('item', Compekit::find($req->num('id')));
    }

    public function remove(Req $req)
    {
        return Compekit::deleteRSP($req->num('id'));
    }
