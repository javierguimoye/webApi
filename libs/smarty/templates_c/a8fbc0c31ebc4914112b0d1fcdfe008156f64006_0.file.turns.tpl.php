<?php
/* Smarty version 3.1.31, created on 2018-05-04 19:35:35
  from "/Users/Alvaro/Work/Web/Wabir-PMS/views/turns.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5aecfc57aee643_64705083',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a8fbc0c31ebc4914112b0d1fcdfe008156f64006' => 
    array (
      0 => '/Users/Alvaro/Work/Web/Wabir-PMS/views/turns.tpl',
      1 => 1524968561,
      2 => 'file',
    ),
  ),
...
function content_5aecfc57aee643_64705083 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            <?php if ($_smarty_tpl->tpl_vars['stg']->value->can_edit) {?>
                <a class="btn btn-primary" onclick="MTurn.add();">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped mdl-td fils_table">
                ...
                <tr>
                    <th width="1%">#</th>
                    <th> Nombre</th>
                    <th width="1%" class="nowrap"><i class="fa fa-clock-o"></i> Desde</th>
                    <th width="1%" class="nowrap"><i class="fa fa-clock-o"></i> Hasta</th>
...
?>
                        <tr>
                            ...
                            <td><?php echo $_smarty_tpl->tpl_vars['m']->value->time_from;?>
</td>
                            <td><?php echo $_smarty_tpl->tpl_vars['m']->value->time_to;?>
</td>
                            <td class="nowrap"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['m']->value->date_created,"%d/%m/%Y %I:%M %p");?>
</td>
                            <td>
                                <?php if ($_smarty_tpl->tpl_vars['stg']->value->can_edit) {?>
                                    <span class="btn dark btn-sm mrg-0" onclick="MTurn.edit(items[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]);">
