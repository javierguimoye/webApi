<?php
/* Smarty version 3.1.31, created on 2018-05-03 14:22:23
  from "/Users/Alvaro/Work/Web/Dev/views/reception.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5aeb616f3c3369_52345849',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '259eaff3273b6423079985bbad9c55ae42c83b1e' => 
    array (
      0 => '/Users/Alvaro/Work/Web/Dev/views/reception.tpl',
      1 => 1525375342,
      2 => 'file',
    ),
  ),
...
function content_5aeb616f3c3369_52345849 (Smarty_Internal_Template $_smarty_tpl) {
...
10.50</td>
    ...
    <form class="portlet light rcp_back" id="form" style="display:block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            ...
                            <div class="form-group tooltips" title="Número de noches">
                                <input class="form-control ctr touchspin" placeholder="Noches" value="1"
                    ...
                    <div class="form-group tooltips" title="Comprobante de pago">
                        <div class="input-group">
                            ...
                            <div class="input-icon right">
                                ...
                                <select class="form-control" style="border-radius:0 4px 4px 0;-webkit-appearance:none">
                                    <?php
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <a class="btn btn-block dark pull-right tooltips" title="Agregar forma de pago">
...
?>
                    ...
                    <div class="hide" style="border-top:1px solid #eee; padding-top:10px">
                        ...
                        <div class="form-group mrg-b-5">
                            ...
                            <div class="input-group hide">
                                ...
                                <span class="input-group-addon pdg-0" style="border:none;visibility:hidden"></span>
                                <input class="form-control" style="border-radius:4px" placeholder="Referencia">
                                <span class="input-group-addon pdg-0" style="border:none;visibility:hidden"></span>
                                ...
                                <span class="input-group-addon pdg-0" style="border:none;visibility:hidden"></span>
                                <input class="form-control" style="border-radius:4px;width:80px" placeholder="0.00">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon" style="min-width:100px;text-align:left;vertical-align:top;padding-top:10px">
                                <i class="fa fa-sticky-note"></i> Notas
                            </span>
                            <textarea class="form-control" placeholder="Escribir..."></textarea>
                        </div>
                    </div>
                ...
                <div class="col-sm-7">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="form-control" placeholder="Buscar...">
                            <span class="input-group-addon btn btn-default tooltips" title="Todas las categorías"
                                  data-placement="bottom" style="border-left:none">
                                <i class="fa fa-th-large font-dark"></i>
                            </span>
                            <span class="input-group-addon btn btn-default tooltips" title="Categorías favoritas"
                                  data-placement="bottom" style="border-left:none">
                                <i class="fa fa-star font-dark"></i>
                            </span>
                            <span class="input-group-addon btn btn-default tooltips" title="Habitaciones"
                                  data-placement="bottom" style="border-left:none">
                                <i class="fa fa-bed font-dark"></i>
                            </span>
                            <span class="input-group-addon btn btn-default tooltips" title="Consumo independiente"
                                  data-placement="bottom" style="border-left:none">
                    ...
                    <!--categorias-->
                    <div class="panel-group accordion prodcats" id="accordion1">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a class="accordion-toggle  <?php if ($_smarty_tpl->tpl_vars['i']->value > 0) {?>collapsed<?php }?> clearfix" data-toggle="collapse"
                                       data-parent="#accordion1" href="#collapse_<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
">
...
" class="panel-collapse <?php if ($_smarty_tpl->tpl_vars['i']->value == 0) {?>in<?php } else { ?>collapse<?php }?>">
                                    <div class="panel-body products">
                                        ...
                                        <div class="btn-group">
                                            <button class="btn grey-gallery btn-lg dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> Large button
                                                <i class="fa fa-angle-down"></i>
                                            </button>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1"
                                       href="#collapse_2"> Collapsible Group Item #2 </a>
                                </h4>
                            </div>
